...
#' basal area (plant size) and W, fitness measured as fruit production.
#' 
#' This dataset was kindly provided by Mariano Ordano and co-workers. Please, 
#' cite as Ordano et al. 2008 (see references).
#' 
#' @docType data
#'   
#' @usage data(sorbus)
