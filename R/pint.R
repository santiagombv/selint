...
#' @param correct Whether or not to correct INT by sample size. Default is 
#'   \code{TRUE}.
#' @param ... Additional arguments to be passed to function \code{cor}
#'   
#' @details The Wagner-Cheverud index of morphological integration (Wagner 1984,
...
#'   
#' @return the vector of individual jackknife pseudovalues of the 
...
#' @references Cheverud, J.M., Wagner, G.P., and Dow, M.M. 1989. Methods for the
...
#' @references Wagner, G.P. 1984. On the eigenvalue distribution of genetic and 
